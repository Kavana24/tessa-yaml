...
for ((i=0; i<$inputLength ; i++))
        ...
        if [ $outputbucketvalue -eq 1 ]
                ...
                expidnew=`mysql -h10.60.2.8 -P3306 -ujenkinsuser -pjenkins123 -D tessa_output -B -N -e "Select ExperimentID  from cellranger_new_output_details where Outputgcsbucket = '$outputgcsbucket'";`
